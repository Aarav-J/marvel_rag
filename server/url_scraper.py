...
print(f"Filtered {len(lines) - len(filtered_lines)} URLs that were already in urls_20.txt")
print(f"New URLs written to new_urls.txt: {len(filtered_lines)}")